...
class MyFrame(wx.Frame):
    ...
    def __init__(self, zoom):
        ...
        self.sizer_algo.Add(self.image_input_window_orig, flag = wx.ALIGN_CENTER)
    ...
    def OnLaunch(self, evt):
        if not self.actif:
            ...
            thread.start_new_thread(Break_Captcha_util.break_captcha, (self.model, self.captcha, self.width_picker.GetValue(), self))
        else:
    ...
    def OnSelectModel(self, evt):
        dlg = wx.FileDialog(self, "Choisissez le modele a ouvrir", os.getcwd(), "model.svm",
    ...
    def OnSelectCaptcha(self, evt):
        dlg = wx.FileDialog(self, "Choisissez l'image a ouvrir", os.path.join(os.getcwd(), "Captchas"), "Image011.jpg",
